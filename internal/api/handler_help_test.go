...
func TestAnalyzeRaw_SyntaxError_HintMapping(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedHelpExplanation: "line 2, column 20",
		...
		},
		{
			...
			expectHelpSuggestion:    true,
			expectedHelpTitle:       "syntax",
			expectedHelpExplanation: "line 2, column 24",
		},
		{
			name:                    "unterminated quoted node label maps to dedicated hint and help",
			syntaxErr:               &parser.SyntaxError{Message: "Parse error on line 2", Line: 2, Column: 12},
			code:                    "flowchart TD\n  A[\"Start] --> B",
		...
		{
			name:                    "unterminated quoted edge text maps to dedicated hint and help",
			syntaxErr:               &parser.SyntaxError{Message: "Parse error on line 2", Line: 2, Column: 18},
			code:                    "flowchart TD\n  A -->|\"Yes| B",
			expectedHintCode:        "unterminated_quoted_label",
			expectedHintMessage:     "matching quote",
			expectHelpSuggestion:    true,
...

		{
			...
			expectHelpSuggestion:    true,
			expectedHelpTitle:       "syntax",
			expectedHelpExplanation: "line 4, column 2",
			expectedAppliesToLine:   2,
		},
		{
		...
		},
		{
			...
			expectedHintMessage:     "line 3, column 8",
			expectHelpSuggestion:    true,
			expectedHelpTitle:       "syntax",
			expectedHelpExplanation: "line 3, column 8",
		},
		{
			name:                    "generic fallback adds token-aware guidance for unexpected angle bracket",
			syntaxErr:               &parser.SyntaxError{Message: "Parse error: unexpected '<'", Line: 2, Column: 17},
			code:                    "flowchart TD\n  A --> B",
			expectedHintCode:        "generic_syntax_error",
			expectedHintMessage:     "parser flagged '<'",
			expectHelpSuggestion:    true,
			expectedHelpTitle:       "syntax",
			expectedHelpExplanation: "line 2, column 9",
		},
		{
			name:                    "generic fallback adds token-aware guidance for BRKT token",
			syntaxErr:               &parser.SyntaxError{Message: "Expecting BRKT, got EOF", Line: 2, Column: 11},
			code:                    "flowchart TD\n  A --> B",
			expectedHintCode:        "generic_syntax_error",
			expectedHintMessage:     "bracket mismatch",
			expectHelpSuggestion:    true,
			expectedHelpTitle:       "syntax",
			expectedHelpExplanation: "line 2, column 9",
		},
